...
function PopUp() {
  ...
  return (
    <>
      ...
      <div className={style.productDetailsLink}>
        <a href="/recipes">Recipes</a>
         /
        <h1>{recipe?.name}</h1>
      </div>
      <div className={style.productWraapper}>
        <div className={style.productImageContainer}>
          <img src={`/images/${recipe.images.split('/').pop()}`} alt={recipe.name} />
        </div>
        ...
        <div className={style.productName}>
          ...
          <div className={style.cookTimeContainer}>
            <span className={style.servingIcon}>
              <svg
                width="20px"
                height="20px"
                viewBox="0 0 24 24"
          ...
          <div className={style.instructionContainer}>
            <h2>Instruction</h2>
            {recipe.Instruction.map((list, index) => (
              <ul>
